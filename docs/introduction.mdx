...
Unlike geopandas, mundi.py does not extend from pandas. This results in more Pythonic syntax, [improved performance](/performance), and reduced memory consumption.
